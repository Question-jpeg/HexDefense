...
const levelConfig = {
  1: { shotInterval: 300, holes: [0], strength: 1 },
  2: { shotInterval: 150, holes: [-0.15, 0.15], strength: 1 },
  3: { shotInterval: 100, holes: [-0.35, 0, 0.35], strength: 1 },
  4: { shotInterval: 100, holes: [-0.35, 0, 0.35], strength: 1 + 1 / 3 },
};

const WhiteGun = React.forwardRef(({ level, size, cellSize }, ref) => {
  const { shotInterval, holes, strength } = levelConfig[level];
  ...
  const distanceConstant = cellSize * 1.1 + cellSize / 2;
